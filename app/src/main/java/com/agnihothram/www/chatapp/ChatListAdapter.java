...
public class ChatListAdapter extends BaseAdapter {
    ...
    private void chatRowStyling(boolean isItme, ViewHolder holder) {
        if (isItme) {
            ...
            holder.senderName.setTextColor(Color.GRAY);
            holder.chatBody.setBackgroundResource(R.drawable.rounded_button_lightgreen);
        } else {
            holder.layoutParams.gravity = Gravity.START;
            holder.senderName.setTextColor(Color.GRAY);
            holder.chatBody.setBackgroundResource(R.drawable.rect_round);
